// Phase 2: port of `src-tauri/src/commands/screenshare.rs` into the napi dispatch
...
// docs/electron-migration-inventory.md under the `screenshare` section. Channel-
