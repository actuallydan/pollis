...
**Status:** Design spec — decision document. No code. The team reads this to decide *whether* and *in what order* to strip server-visible sender identity and shrink the social-graph / timing / signalling metadata Pollis exposes at the application layer.
