...
| Auditor CLI release | `.github/workflows/verifier-release.yml` | Ships `pollis-verify` binaries + SHA256SUMS with the **pinned public key** in the release body (ML-DSA-44; rotated in #732). |
...
| **binary transparency STH** | *hash* of payload+artifact | Pollis ML-DSA-44 (rotated #732) | `pollis-verify`, in-app | equivocation / targeted-build / "what source is this" |
