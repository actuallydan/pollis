...
//! exponential backoff loop, not a reconnect-and-retry-once seam like the
//! `RemoteDb::with_retry` #987 deleted; the two solve different problems and
//! this file never used the latter.
//!
