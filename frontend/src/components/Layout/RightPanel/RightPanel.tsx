  ...
  return (
    ...
    >
      ...
      <button
        ...
        title={closeLabel}
        className="flex shrink-0 cursor-pointer items-center gap-2 border-t border-line px-2.5 min-h-composer-flush text-start text-xs text-muted transition-colors hover:text-fg"
      >
