...
const PAGE_RESULTS: SearchResultItem[] = [
  ...
  { type: "page", id: "page-voice-settings", name: "Voice & Video", breadcrumb: "/settings/voice", path: "/voice-settings", keywords: "microphone speaker audio mic noise suppression echo cancellation agc auto join camera webcam video preview" },
