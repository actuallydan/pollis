...
//! source and (macOS) the capture-helper handles. Independent of
//! `ScreenShareState`: a user can screen-share and webcam simultaneously,
//! so the two never share a track, source, or helper slot.
